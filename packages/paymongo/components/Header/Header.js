...
function Header({ mode = 'dark' }) {
  ...
  return (
    <header>
      <nav className="max-w-screen-lg mx-auto flex items-center justify-between flex-wrap p-6">
        ...
        >
          ...
          <div>
            <a
              href="#"
              className="inline-block text-base px-6 py-3 leading-none border rounded text-primary border-primary hover:border-transparent hover:text-white hover:bg-primary mt-4 lg:mt-0"
            >
              Log in
            </a>
          </div>
